# CREAO Premium Landing Page Pack — 100 Niches

100 production-ready premium landing pages across different niches and styles — **dark and light**, three layouts — each generated from **one master prompt framework** using [CREAO](https://agent.creao.ai/@Sonofpeace). Every page ships with the exact prompt that built it, so anyone can copy, edit, and make it their own.

51 are SaaS products, 12 are local service businesses (plumbing/HVAC, dental, restaurant, gym, salon, spa, auto repair, law firm, photography, cleaning, landscaping, wedding planning), 9 are retail/e-commerce brands (furniture, sneakers, electronics, apparel, beauty, jewelry, decor, a hardware launch, a subscription box), 6 are real estate & property (residential agency, property management, vacation rentals, commercial brokerage, architecture, interior design), 8 are institutions & community (church, K-12 school, university, medical clinic, veterinary clinic, daycare, nonprofit, coworking space), and 11 are portfolio & creative (product designer, photographer, creative agency, fine artist, freelance consultant, video editor, musician, author, speaker/coach, illustrator, talent/model) — all on the same design system. 100 niches, shipped in themed batches. The gallery itself has a light/dark toggle, and every hero visual is either a bold niche-specific icon badge or, for product brands, a large illustration of the actual product.
...
- **`<slug>-landing.html`** — 100 standalone, self-contained landing pages (inline CSS + JS, Google Fonts via link). No build step.
...
**Portfolio & creative (11):** product designer, photographer, creative agency, fine artist, freelance consultant, video editor, musician & band, author & book launch, speaker & coach, illustrator, talent & model.
